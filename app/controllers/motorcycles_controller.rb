class MotorcyclesController < ApplicationController
  ...
  private
    ...
    def motorcycle_params
      params.require(:motorcycle).permit(:name, :price, 
                                    specifications_attributes: [:name, :price,
                                          :motorcycle_id, :id], 
                                    types_attributes: [:name, :price, 
                                          :motorcycle_id, :id, :_destroy, galleries_attributes: 
                                          [:type_id, :id, images_attributes: [:id, :gallery_id, :photo]]
                                    ]
                                    )
    end
end
