...
class MotorcyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motorcycle" do
    assert_difference('Motorcycle.count') do
      post motorcycles_url, params: { motorcycle: { name: @motorcycle.name, price: @motorcycle.price } }
    end
  ...
  test "should update motorcycle" do
    patch motorcycle_url(@motorcycle), params: { motorcycle: { name: @motorcycle.name, price: @motorcycle.price } }
